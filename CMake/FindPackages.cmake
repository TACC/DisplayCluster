...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Boost 1.41.0 COMPONENTS date_time serialization)
...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Qt4 4.6 COMPONENTS QtNetwork QtOpenGL QtXml QtXmlPatterns)
...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT TUIO_FOUND) AND (NOT TUIO_FOUND))
    message(FATAL_ERROR "Could not find TUIO")
  endif()
else()
